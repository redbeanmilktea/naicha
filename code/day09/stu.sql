...
INSERT INTO `cls` VALUES (1,'Lily',19,'w',96),(2,'Tom',18,'m',76),(3,'Abby',18,'w',87),(4,'Baron',20,'m',93),(6,'Alex',20,'m',91),(7,'Emma',18,'w',66),(8,'Zhu',18,'m',66);
...
INSERT INTO `hobby` VALUES (1,'Joy','sing',15800.00,NULL,'天籁之音'),(2,'Lily','sing,dance',46800.00,NULL,'骨骼惊奇'),(3,'Tom','draw',8800.00,NULL,'当代达芬奇'),(4,'Emma','draw',16880.00,NULL,'当代毕加索');
...
INSERT INTO `marathon` VALUES (1,'尼古拉斯赵四','1993-02-28','2020-01-06 18:20:36','02:28:44'),(2,'曹操','1995-04-05','2020-01-08 10:32:36','02:15:40'),(3,'史蒂芬','1997-07-19','2020-01-07 11:00:36','02:49:26'),(4,'小泽','1999-01-31','2020-01-07 10:30:26','02:38:26'),(5,'彪哥','1994-01-01','2020-07-03 14:08:44','02:40:40');
...
INSERT INTO `person` VALUES (1,'Lily',33,'w',25000.00,'2017-04-03',NULL),(2,'Tom',27,'m',16000.00,'2019-10-03',1),(4,'Emma',24,'w',8000.00,'2019-05-08',4),(5,'Abby',28,'w',17000.00,'2018-11-03',3);
...
INSERT INTO `shu` VALUES (5,'刘备','男','蜀',220,59),(6,'诸葛亮','男','蜀',170,54),(7,'赵云','男','蜀',360,70),(8,'张飞','男','蜀',370,80),(9,'孙尚香','女','蜀',249,62);
/*!40000 ALTER TABLE `shu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `student_hobby`
--

DROP TABLE IF EXISTS `student_hobby`;
/*!50001 DROP VIEW IF EXISTS `student_hobby`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `student_hobby` AS SELECT 
 1 AS `name`,
 1 AS `score`,
 1 AS `hobby`,
 1 AS `price`*/;
...
--
-- Final view structure for view `student_hobby`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `student_hobby` AS select `cls`.`name` AS `name`,`cls`.`score` AS `score`,`hobby`.`hobby` AS `hobby`,`hobby`.`price` AS `price` from (`cls` join `hobby` on((`cls`.`name` = `hobby`.`name`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-07-07 15:22:36

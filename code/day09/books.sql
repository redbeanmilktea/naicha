...
CREATE TABLE `作家_出版社` (
  ...
  KEY `aid` (`aid`),
  KEY `pid` (`pid`),
  CONSTRAINT `作家_出版社_ibfk_1` FOREIGN KEY (`aid`) REFERENCES `作家` (`id`),
  CONSTRAINT `作家_出版社_ibfk_2` FOREIGN KEY (`pid`) REFERENCES `出版社` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `book` VALUES (1,'边城','沈从文','机械工业出版社',36,'2019-10-01','小城故事多'),(2,'骆驼祥子','老舍','机械工业出版社',43,'2018-10-01','你是祥子么？'),(3,'茶馆','老舍','中国文学出版社',55,'2018-10-01','老北京'),(4,'呐喊','鲁迅','人民教育出版社',45,'2019-10-01','最后的声音'),(5,'朝花夕拾','鲁迅','中国文学出版社',53,'2020-01-01','好时光'),(6,'围城','钱钟书','中国文学出版社',44,'2020-01-01','你心中的围城是什么'),(7,'林家铺子','茅盾','机械工业出版社',51,'2019-10-01',NULL),(8,'冰心全集','冰心','人民教育出版社',47,'2019-10-01',NULL);
...
-- Dump completed on 2020-07-07 15:23:02
